...
-- Dumping structure for table test.optdef
...
-- Dumping data for table test.optdef: ~7 rows (approximately)
/*!40000 ALTER TABLE `optdef` DISABLE KEYS */;
INSERT INTO `optdef` (`Id`, `Underlying`, `Level1`, `Level2`, `Level3`, `Level4`, `Level5`, `NotAbove`, `NotBelow`, `IVTop`, `IVBottom`, `WeeklyExpiryTargetUp`, `WeeklyExpiryTargetDown`, `Trend15M`, `MaxPainDirection`, `MaxPainTarget`, `PCRDirection`, `PCRUp`, `PCRDown`) VALUES
...
/*!40000 ALTER TABLE `optdef` ENABLE KEYS */;
